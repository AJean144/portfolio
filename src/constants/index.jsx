...
const testimonials = [
  ...
  //   testimonial: "...",
  //   name: "Jameyel",
  //   designation: "Director of Innovation | Architecture",
...
const projects = [
  ...
  //   name: "Everly Health",
  //   description: `
  //   At Everly Health, I work on developing and maintaining the platform that supports
  //   their innovative at-home health testing services. Core responsibilities include
  //   building and optimizing the website for user experience, developing secure data
  //   processing systems for test results, integrating with telehealth services,
  //   and ensuring scalability and reliability of the platform on AWS.
  //   The work also involve ensuring the privacy and security of health data,
  //   supporting a wide range of health tests, and providing users with clear,
  //   actionable insights based on their test results.
  //     `,
  //   tags: [
  //     {
  //       name: "react",
  ...
  //     },
  //   ],
  //   image: everlyHealthImage,
  //   source_code_link: "https://everlywell.com/",
  // },
  // {
  //   name: "Politech - Blocks Application",
  //   description: `
  //     Blocks offers cutting-edge tools for voter registration,
  //     organizing, and petitioning tailored for the progressive movement.
  //     As a software engineer at Politech, I worked with a tech stack including React.js,
  //     Redux, Ruby on Rails, PostgreSQL, and AWS. My focus was on
  //     developing and maintaining features that support these core activities.
  //     Responsibilities included building and optimizing user interfaces
  //     for campaign management, enhancing backend systems for data processing
  //     and analytics, ensuring data integrity and security,
  //     and scaling infrastructure on AWS to support high-traffic periods during campaigns.
  //     `,
  //   tags: [
  //     {
  //       name: "react",
  ...
  //   ],
  //   image: politechImage,
  //   source_code_link: "https://blocks.app/",
  // },
  // {
  //   name: "Aloft",
  //   description: `
  //     Aloft is focused on drone fleet management software and UTM (Unmanned Aircraft System Traffic Management) services.
  //     As a Senior Software Engineer at Aloft, I worked on developing and enhancing these platforms,
  //     contributing to features like airspace management, fleet tracking, LAANC authorizations, safety advisories,
  //     and mission planning with risk assessments. The role also involved working with technologies for enterprise drone fleet management,
  //     including user management, reporting, security (SOC2/ISO27001), integrations, APIs, and live video streaming functionalities.
  //     `,
  //   tags: [
  //     {
  //       name: "nextjs",
  ...
  //   ],
  //   image: aloftImage,
  //   source_code_link: "https://www.aloft.ai/",
  // },
];
